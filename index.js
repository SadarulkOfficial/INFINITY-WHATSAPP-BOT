...
console.log('Infinity wa bot installing 😼...')
...
await conn.sendMessage(mek.key.remoteJid, { react: { text: "〽️" }})
}
...
app.get("/", (req, res) => {
res.send("Hey, Infinity wa bot started ✅");
});
